...
contract Consensus2021ChainlinkWeatherNFT is ERC721, Ownable, ChainlinkClient {
    ...
    function mintProjectNFT() public onlyOwner{
    ...
    function setProejctURI(string memory weather, string memory tokenUri, uint256 tokenId) public onlyOwner {
...
//Password is needed to set up Oracle request. What does each response stand for? 
...
//Mint NFT after precise proof is generated
